PureJSDialog.factory = function() {
    ...
    return {
        ...
        resizeModal: function() {
            var dialogMessage = PureJSDialog.utils.getById( 'pure-js-dialog-message' ),
                dialogContainer = PureJSDialog.utils.getById( 'pure-js-dialog-container' ),
            ...
            this.setElementHeight( dialogMessage, dialogContainerHeight );
        },
